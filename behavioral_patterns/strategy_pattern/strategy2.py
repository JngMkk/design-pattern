...
class TiledStrategy:
    ...
    def __call__(self, img_file: Path, desktop_size: _SIZE) -> Image:
        """
...
class Resizer:
    def __init__(self, strategy: Callable[[Path, _SIZE], Image.Image]) -> None:
        self.strategy = strategy

    def resize(self, img_file: Path, size: _SIZE) -> Image:
        return self.strategy(img_file, size)
